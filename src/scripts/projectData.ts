...
const data: ProjectDataType[] = [
    
    {
        ...
        Crafted a beautiful online home for this dental clinic using HTML, CSS, and JavaScript. 
    ...
    },
    {
        ...
        Combining programming and art, this Google Spreadsheets Extension converts images into vibrant pixel art using
         Vanilla JavaScript, color recognition, and algorithms. 
         Empowering users to infuse artistry into their data-driven world.`,
        imgName: 'pixel.png',
        id: 'pixel-art',
        shadowColor: '#82ff9e'
    },
 ...
 
    {
        ...
        Developed using TailWindCSS, it perfectly met customer expectations with flying colors.`,
        imgName:'ravella.png',
        imgAlt:'ravella.png',
        id:'ravella',
